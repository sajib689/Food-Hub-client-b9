      ...
      <div className="container max-w-6xl mb-3  px-6 py-10 mx-auto">
        ...
        <div className="w-[300px] mt-4">
          <label className="  flex items-center gap-2">
            <input value={query} onChange={(e) => setQuery(e.target.value)} type="text" className="grow focus:outline-none" placeholder="Search" />
            <button onClick={handleSearch} className="btn bg-blue-500 text-white hover:bg-blue-600">
            Search
            </button>
          </label>
        </div>
